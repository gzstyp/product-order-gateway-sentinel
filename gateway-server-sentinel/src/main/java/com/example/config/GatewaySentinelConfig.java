...
public class GatewaySentinelConfig{
    ...
    public void initGatewayRules(){
        ...
        //分组限流
        rules.add(new GatewayFlowRule("order-api").setCount(3).setIntervalSec(60));//订单
        rules.add(new GatewayFlowRule("product-api").setCount(3).setIntervalSec(60));//商品
        //加载网关限流规则
    ...
    protected void initCustomizedApis(){
        ...
        //product-api 组
        final ApiDefinition apiProduct = new ApiDefinition("product-api").setPredicateItems(
            new HashSet<ApiPredicateItem>(){
                {
                    //匹配/producr-service/product 以及其子路径的所有请求 http://127.0.0.1:9001/product-service/product/1
                    ...
                    //匹配/product 以及其子路径的所有请求 http://127.0.0.1:9001/product/1
